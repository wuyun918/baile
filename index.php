...
function index_get_cat_id_goods_best_list($cat_id, $num)
{
    $sql = 'Select g.goods_id, g.goods_name, g.goods_name_style, g.market_price, g.shop_price, g.promote_price, ' .
                ...
                "g.is_best, g.is_best, g.is_hot, g.is_promote " .
...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
	...
	$smarty->assign('cat_id141_best_goods', index_get_cat_id_goods_best_list(141,9));
	$smarty->assign('cat_id167_best_goods', index_get_cat_id_goods_best_list(167,9));
 $smarty->assign('cat_id157_best_goods', index_get_cat_id_goods_best_list(157,9));
